...
import { DiReact } from "react-icons/di";               // for React icon
import { SiMongodb, SiNodedotjs, SiRedux } from "react-icons/si"; // for MongoDB, Node.js, Redux
          ...
          <div className="flex items-center gap-2">
            {item.techIcons.map((tech, index) => {
              ...
              return (
                <IconComponent
                  key={index}
                  className="w-[25px] h-[25px] grayscale group-hover:grayscale-0"
                />
              );
            })}
          </div>
